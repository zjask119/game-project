...
def get_heroes_from_db():
    ...
    cursor = conn.cursor()
    query = 'select id, name, hp, defence, speed, recovery, mind, race, nature, movement, sense, solar, path from Hero'
    ...
    for db_hero in db_heroes:
        hero_id, name, hp, defence, speed, recovery, mind, race, nature, movement, sense, solar, img_path = db_hero
        hero = Hero(name, hp, defence, speed, recovery, mind, race, nature, movement, sense, solar, img_path)
        heroes[hero_id] = hero
    ...
    for hero_id, move in moves:
        ...
        elif move.type == 'energy' or move.type == 'attack':
            move.speed = 0.01 * move.speed * hero.speed
            move.initial_speed = 0.01 * move.initial_speed * hero.speed
        hero.add_move(move)
